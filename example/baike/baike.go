...
func main() {
	...
	sp := robot.NewSpider(NewMyPageProcesser(), "TaskName")
	...
	//  7. Cookies
	req := robot.NewRequest("http://baike.baidu.com/view/1628025.htm?fromtitle=http&fromid=243074&type=syn", "html", "", "GET", "", nil, nil, nil, nil)
	...
	var reqs []*robot.Request
	for _, url := range urls {
		req := robot.NewRequest(url, "html", "", "GET", "", nil, nil, nil, nil)
